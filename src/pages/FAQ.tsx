...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-32 pb-24">
        {/* Animated Background */}
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-8 relative z-10 pb-24">
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            {/* Background effects */}
            ...
            <div className="relative p-12 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group px-8 py-5 bg-white text-slate-900 rounded-2xl font-bold flex items-center justify-center gap-3 shadow-2xl hover:shadow-white/20 transition-all"
                >
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-5 bg-white/10 backdrop-blur-sm text-white rounded-2xl font-bold flex items-center justify-center gap-3 border border-white/20 hover:bg-white/20 transition-all"
                >
                  <Phone size={22} />
